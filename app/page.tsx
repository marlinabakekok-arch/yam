...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
          ...
          <div className="flex items-baseline justify-between">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-2">
                Discover our trending collection
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-12 text-center dark:border-slate-800 dark:bg-slate-950">
            <p className="text-slate-600 dark:text-slate-400">
              {dbError 
                ...
                : 'No fashion items available yet.'}
            </p>
          </div>
        ) : (
      ...
      {/* Jewelry Section */}
      {kalungProducts.length > 0 && (
        <section className="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-slate-900 dark:to-slate-800">
                  ...
                  <Card className="group overflow-hidden border-0 shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                    ...
                    <div className="flex-1 p-4 flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="font-semibold text-slate-900 dark:text-white group-hover:text-yellow-600 transition-colors line-clamp-2">
                          {product.name}
                        </h3>
                        <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2 mt-2">
                          {product.description}
